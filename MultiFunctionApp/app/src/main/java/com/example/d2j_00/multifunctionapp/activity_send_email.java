...
public class activity_send_email extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_activity_send_email);
    }
    public void sendemail(View view){
        ...
        emailIntent.putExtra(Intent.EXTRA_EMAIL,("ademugroho404@gmail.com"));
